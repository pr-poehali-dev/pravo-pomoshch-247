...
const faqItems = [
  {
    question: 'От чего зависит стоимость услуг адвоката?',
    answer: 'От сложности дела, стадии процесса, количества заседаний, объема работы с документами. Уголовные дела дороже гражданских из-за повышенной ответственности и срочности.'
  },
  {
    question: 'Можно ли оплатить услуги частями?',
    answer: 'Да, возможна рассрочка платежа. Обычно первый платеж при заключении договора (30-50%), остальное — по этапам работы. Детали обсуждаются индивидуально.'
  },
  {
    question: 'Что входит в указанную стоимость?',
    answer: 'Консультации, подготовка всех документов, участие в заседаниях по данной инстанции, телефонная поддержка. Дополнительно оплачиваются госпошлины, экспертизы, нотариальные услуги.'
  },
  {
    question: 'Почему цены "от"? Какая будет итоговая стоимость?',
    answer: 'Минимальная цена — за типовые простые дела. Итоговая стоимость зависит от сложности, срочности, региона. Точную цену назовем после бесплатной консультации и изучения ситуации.'
  },
  {
    question: 'Есть ли скрытые платежи?',
    answer: 'Нет. Все условия фиксируются в договоре. Если в процессе потребуются дополнительные услуги (экспертиза, апелляция) — согласовываем с вами заранее.'
  },
  {
    question: 'Можно ли вернуть деньги, если передумаю?',
    answer: 'Да, по договору можно расторгнуть соглашение. Оплачивается только фактически выполненная работа. Если услуга еще не оказана — возвращаем предоплату.'
  },
  {
    question: 'Дешевле ли обойдется самостоятельная защита?',
    answer: 'Не всегда. Ошибки без адвоката могут привести к проигрышу дела, реальному сроку, большим штрафам. Профессиональная защита часто экономит деньги и нервы.'
  },
  {
    question: 'Предоставляете ли скидки?',
    answer: 'Да, для пенсионеров, многодетных семей, инвалидов — скидка 10-15%. Для постоянных клиентов и при одновременном ведении нескольких дел — индивидуальные условия.'
  },
  {
    question: 'Сколько стоит срочный выезд к задержанному?',
    answer: 'От 30 000 ₽ за выезд и участие в первых допросах. В стоимость входит контроль процедуры задержания, консультация, сопровождение до решения вопроса о мере пресечения.'
  },
  {
    question: 'Что дороже — почасовая оплата или фиксированная?',
    answer: 'Зависит от дела. Для коротких дел (1-2 заседания) выгоднее почасовая (от 5000 ₽/час). Для длительных — фиксированный пакет. Предложим оптимальный вариант.'
  },
  {
    question: 'Нужно ли платить, если дело выиграно не полностью?',
    answer: 'Да, оплачивается проделанная работа независимо от исхода. Но мы всегда стремимся к максимально возможному результату в рамках закона.'
  },
  {
    question: 'Можно ли взыскать стоимость адвоката с проигравшей стороны?',
    answer: 'Да, в гражданских делах расходы на юриста взыскиваются с проигравшей стороны (обычно частично). В уголовных делах — только если вы потерпевший и подавали гражданский иск.'
  }
];