...
const services: Service[] = [
  ...
  },
  {
    ...
    details: {
      ...
      advantages: [
        'Специализация по Свердловской области',
        'РВП за 4-6 месяцев, ВНЖ за 4-6 месяцев',
        'Гражданство за 1-3 года',
      ...
      documents: [
        ...
        'Медицинские справки (ВИЧ, туберкулез, наркология)',
        'Документы об образовании с апостилем',
        'Справки о доходах и трудовой деятельности',
        'Документы для экзамена по русскому языку и истории'
      ],
      process: [
        'Консультация и анализ ситуации (от 30 минут)',
        'Подготовка документов и переводов (3-5 дней)',
        'Подача заявления в МВД Свердловской области (1 день)',
        'Сопровождение рассмотрения (2-6 месяцев)',
        'Получение документов в Екатеринбурге (1-2 дня)',
        'Постановка на учет и регистрация (1-3 дня)'
      ],
      guarantees: [
        'Работа до результата или возврат средств',
